...
--
-- Host: localhost:3306
-- Generation Time: Apr 09, 2026 at 05:37 PM
...
CREATE TABLE `exam` (
  ...
  `questionSets` int NOT NULL DEFAULT '0',
  `questionType` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `employerId` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `question` (
  ...
  `type` enum('CHECKBOX','RADIO','TEXT') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'RADIO',
  `createdAt` datetime(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
  `updatedAt` datetime(3) NOT NULL,
...
CREATE TABLE `submission` (
  `id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` enum('ASSIGNED','PENDING','IN_PROGRESS','COMPLETED') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PENDING',
  `score` double NOT NULL DEFAULT '0',
  `tabSwitches` int NOT NULL DEFAULT '0',
  `fullscreenExits` int NOT NULL DEFAULT '0',
...
('cmnrra6k500012orgpz98yrgx', 'employer@akij.work', '$2b$10$82SDliY4Y5vjwEycv5MJO.eRPL.wrTPUHX8leTRCFvd2h.hMdl4ry', 'EMPLOYER', '2026-04-09 17:33:35.286', '2026-04-09 17:33:35.286', 'Employer At Akij', NULL, 'MALE'),
...
--
ALTER TABLE `exam`
  ADD CONSTRAINT `Exam_employerId_fkey` FOREIGN KEY (`employerId`) REFERENCES `user` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
--
ALTER TABLE `submission`
  ADD CONSTRAINT `Submission_examId_fkey` FOREIGN KEY (`examId`) REFERENCES `exam` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
